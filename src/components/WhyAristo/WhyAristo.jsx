...
const WhyAristo = () => {
  ...
  return (
    ...
    >
      <h2 className="text-3xl font-bold mb-3">Why <span className="gradient-text text-4xl">Aristo</span>?</h2>
      <p className="mb-8">"Because Aristo Offers you the following features"</p>
      <div className="px-20">
