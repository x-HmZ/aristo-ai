...
export function Hero() {
  return (
    <section className="relative z-10 mx-auto flex w-full max-w-6xl flex-col items-start gap-12 px-5 pb-16 pt-8 sm:px-8 lg:flex-row lg:items-center lg:gap-14 lg:pb-24 lg:pt-14">
      <div className="flex w-full flex-col items-start gap-6 lg:w-[486px] lg:shrink-0">
        ...
        <div className="flex w-full flex-col gap-3 pt-1 sm:w-auto sm:flex-row sm:items-center sm:gap-3.5">
          <Link
            href="/demo"
            className="inline-flex min-h-[56px] items-center justify-center gap-2.5 rounded-2xl bg-primary px-6 text-base font-bold text-primary-foreground shadow-aristo transition-all hover:-translate-y-0.5 hover:bg-primary/90 hover:shadow-aristo-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
          ...
          <Link
            href="/sign-up"
            className="inline-flex min-h-[56px] items-center justify-center rounded-2xl border border-border bg-white/70 px-6 text-base font-semibold text-foreground transition-colors hover:bg-secondary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
          >
            Create an account
          </Link>
        </div>
