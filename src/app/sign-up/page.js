...
const SignUp = () => {
  ...
  const handleSignUp = async (event) => {
    ...
    try {
      ...
      toast.error('Some Error Ocured. Failed to Sign Up: ');
    ...
    <div className="animated-background min-h-screen flex items-center justify-center">
      ...
      <div className="bg-gray-800 p-10 rounded-lg shadow-xl w-96 outline outline-1 outline-gray-500">
        ...
        <form onSubmit={handleSignUp} >
          ...
          <button type="submit" disabled={loading || user} className="w-full p-3 mt-4 gradient-button rounded">{loading ? 'Loading...' : (user ? "Redirecting..." : "Sign Up")}</button>
